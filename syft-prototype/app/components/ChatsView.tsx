  ...
  return (
    <div className="max-w-2xl mx-auto w-full flex flex-col h-full">
      ...
      <div ref={scrollRef} className="flex-1 overflow-y-auto px-5 py-5 space-y-3">
        {/* Honest framing — no simulated replies */}
        <div className="rounded-xl px-4 py-3 mx-auto text-center" style={{ background: "var(--secondary)", maxWidth: 360 }}>
          <p className="text-muted-foreground" style={{ fontSize: "0.8125rem", lineHeight: 1.55 }}>
            You liked <span className="text-foreground" style={{ fontWeight: 500 }}>{connection.name}</span>. Your messages are
            saved here — they&apos;ll see them once they&apos;re an active member who&apos;s connected with you. Syft never
            fakes a reply.
          </p>
        </div>
